...
exports.postDispatchPage= async (req,res,next)=>{
    ...
    let dispatchBuffer= req.files['dispatch'][0].buffer;
    let starterBuffer= req.files['starter'][0].buffer;
    ...
    await helpers.generacionReporte(dispatchLog, starterLog, fechaInicio,fechaFin, horaInicio, horaFin);
